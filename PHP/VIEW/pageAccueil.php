...
<div class="contenu">
    ...
    La qualité de notre main-d\'oeuvre vous bluffera. Satisfait ou remboursé !
    <br>
    Nous vous proposons nos services dans le monde entier, à des prix imbattables. <br><br>
    N\'attendez plus !
    <br><br>Des prestations de qualité à petits prix, dans un garage chaleureux et accueillant. Car votre véhicule le mérite.<br><br><br>
    En plus, le café est offert.<br><br>

    <div><img id="cafe" src="IMG/cafeoffert.gif" alt="café"></div>
</div>
';